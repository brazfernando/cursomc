...
public class DBService {
	...
	public void intanciarTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fernandocostadsv@gmail.com", "04965565465", TipoCliente.PESSOAFISICA, pe.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("995088995", "95588992"));

		Cliente cli2 = new Cliente(null, "João Costa", "joaocosta@gmail.com", "24319641086", TipoCliente.PESSOAFISICA, pe.encode("1234567"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("9952232223", "95588992"));

		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38225654", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38225654", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 12:35"), cli1, e2);
